        ...
        compile: function(element,attrs) {
        	...
        	// linking function here.
	      	return function(scope,elem,attrs) {
	        	angular.element(elem).rating('create', {disabled: attrs.inputDisabled == "true", showClear : attrs.showClear == "true", showCaption : attrs.showCaption == "true", size : attrs.size, step : attrs.step, min : attrs.min, max : attrs.max});
